import { KaczkolandAPIClient, KaczkolandAPIError } from "./index";
...
test('invalid get player stats', async () => {
    expect(await client.getPlayerStats(undefined!).catch(e => e)).toBeInstanceOf(KaczkolandAPIError);
})